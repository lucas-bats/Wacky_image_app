...
const SkateboardIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6.38 12.39a1.5 1.5 0 0 0-1.13 1.39c-.04.83.6 1.54 1.43 1.58.83.04 1.54-.6 1.58-1.43.04-.83-.6-1.54-1.43-1.58-.1-.01-.2 0-.3-.01m11.19.06a1.5 1.5 0 0 0-1.13 1.39c-.04.83.6 1.54 1.43 1.58.83.04 1.54-.6 1.58-1.43.04-.83-.6-1.54-1.43-1.58-.1 0-.2 0-.3-.01M5.5 10.5l13 .88c.44.03.81.39.85.83l.39 4.35c.03.28-.1.55-.32.73l-1.65 1.32a.89.89 0 0 1-1.09-.21l-1.32-1.65a.89.89 0 0 0-1.09-.21l-1.32 1.65a.89.89 0 0 1-1.09-.21l-1.32-1.65a.89.89 0 0 0-1.09-.21l-1.32 1.65a.89.89 0 0 1-1.09-.21l-1.32-1.65a.89.89 0 0 0-1.09-.21l-1.32 1.65a.89.89 0 0 1-1.09-.21l-1.32-1.65a.89.89 0 0 0-1.09-.21L8.3 16.5a.89.89 0 0 0-1.09-.21L5.89 17.6a.89.89 0 0 1-1.09-.21l-1.32-1.65c-.22-.27-.22-.68 0-.95l2.23-2.78c.31-.39.8-.59 1.29-.53z"/></svg>;
  ...
  const keywordCategories: { [key: string]: { color: string; textColor: string; keywords: { [key: string]: ReactNode } } } = {
    ...
    [T.categoryNames.Settings]: {
      ...
      keywords: {
        ...
        [T.keywordCategories.Settings.keywords['at a disco']]: <Dices />,
    ...
    [T.categoryNames.Styles]: {
      ...
      keywords: {
        ...
        [T.keywordCategories.Styles.keywords['cyberpunk']]: <Bot />,
