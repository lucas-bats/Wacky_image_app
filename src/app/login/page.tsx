...
export default function LoginPage() {
  ...
  // A simple way to manage language state for this page
    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4 font-headline">
      <Card className="w-full max-w-md shadow-2xl border-4 border-border rounded-2xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl tracking-tight">{T.loginTitle}</CardTitle>
          <CardDescription className="font-body text-lg">{T.loginSubtitle}</CardDescription>
        </CardHeader>
